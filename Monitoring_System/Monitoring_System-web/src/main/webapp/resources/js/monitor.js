...
function drawChart() {
    ...
    dataTable.addRows([
        ['Online', 't', new Date(0,0,0,12,0,0), new Date(0,0,0,18,0,0)],
        ...
        ['Features', 't', new Date(0,0,0,12,0,0), new Date(0,0,0,13,0,0)],
        ['Features', 'f', new Date(0,0,0,13,0,0), new Date(0,0,0,18,0,0)]
    ]);
