...
public class MonitoringService {
     ...
     */
    public List<common1.domain1.System> retrieveSystems() {
     ...
     * @return A list
     */
    public void generateServerStatus(common1.domain1.System system) {
        this.manager.generateServerStatus(system);
    }
    
    public List<Test> retrieveLatestTests(common1.domain1.System system) {
